// ============================================================
// Costa Rica 2026 — app logic (adapted from France 2026)
// ============================================================
...
const STORAGE_KEY = 'costarica2026_v1';
const DEPARTURE   = new Date('2026-08-22T10:13:00'); // SAN departure, Aug 22
const PIN_SECRET  = '0000'; // PIN lock disabled for this trip (no private section)
...
// PIN / EDIT LOCK
// ============================================================
// PIN lock disabled for this trip — edits are always allowed.
let editUnlocked  = true;
...
function renderHero() {
  ...
  if (label) label.textContent = diff > 0 ? 'days to departure' : '¡pura vida!';
  ...
  if (trip) trip.textContent = '10 days';
}
...
function applyTweaks() {
  ...
  root.setAttribute('data-theme',   'tropic');
...
function initTripMap() {
  ...
  L.polyline(latlngs, { color: '#0a5c43', weight: 2, opacity: 0.5, dashArray: '6 9' }).addTo(tripMap);
